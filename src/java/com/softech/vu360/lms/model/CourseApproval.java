...
public class CourseApproval extends RegulatoryApproval {
  ...
  @OneToMany
  @JoinTable(name = "COURSEAPPROVAL_PURCHASECERTIFICATE", joinColumns = @JoinColumn(name = "COURSEAPPROVALID") ,
    inverseJoinColumns = @JoinColumn(name = "PURCHASECERTIFICATENUMBERID") )
  ...
  @OneToMany(targetEntity = RestrictedCourse.class, mappedBy = "courseApproval")
  private Set<RestrictedCourse> restrictedCourses;
